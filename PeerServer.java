...
public class PeerServer extends JFrame {
	...
	/*
	 * Server Start has:
	 * run() that set-up the sockets to run and listens to the threads
	 */
		...
		public void run() {
			...
			try {
				...
				while (true) {
					...
					Thread listener = new Thread(new HandleClients(clientSock,
							printer));
					listener.start();
	...
	public void tellEveryone(String message) {
		...
		Iterator it = clientMessages.iterator();
